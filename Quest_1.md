...
> 나를 지키고 분연히 일어나고 성장하려면 자존심을 키워서 다른 사람과 비교하지 말고, 자존감을 키워서 과거의 자신과 비교해야합니다.
> 

어제의 나보다 더 성장했다면 스스로 성취감을 느끼고 불안해하지 않았으면 좋겠습니다.
...
아직도 좋은 코드가 효율성이 높은 코드일까 가독성이 좋은 읽기 좋은 코드일까 고민이 되지만, 인용구처럼 일단 구현하고 그 다음 여유가 생기면 더 좋게 만드는 것을 해보겠습니다.

### J199 - 이지호

> 전문가가 해당 도메인 지식만 뛰어난 사람이라는 것은 대표적인 미신입니다. 전문가는 사회적 자본과 사회적 기술 또한 뛰어납니다. - 함께 자라기 102
> 

'은둔 고수'라는 건 없다는 걸 알게 되었습니다. 지금까지 갖고 있던 편견을 깨주는 문장이었습니다.

### J154 - 안영민

> 기준과 원칙에 따라 빠르게 결정을 내리면, 정말 중요한 설계와 선택이 필요할 때 더 깊게 사고할 수 있는 시간을 확보할 수 있다.   - 개발자 원칙 p208
> 

나만의 개발 원칙 우선순위를 정해둬야겠다는 생각을 했다. '그 기능이 필요하기 전까지는 미리 만들지 말라'와 '제어할 수 없는 것에 의존하지 않기'를 당장 다음주 미션부터 적용해봐야겠다

### J144 - 신성규

> 동일한 자극/조건이 주어졌을 때 어떤 사람은 더 많은 학습과 성장의 기회를 찾는다. - 함께 자라기 43p
> 

회사의 일이든, 챌린지의 미션이든, 세상 일은 힘들고 각박하기 마련이라 선뜻 학습에 에너지를 투자하고 싶지 않은 게 자연스럽다. 그러나 힘든 상황속일수록 큰 학습과 성장의 기회로 전환이 가능하고, '성장하는 개발자'가 목적이라면 기꺼이 이런 전환을 선택하는 게 이득일 것이다.

### J147 - 신지윤

> 실제로 프로덕트를 만드는 상황에 최대한 노출하면 설계의 결함을 발견하거나, 문제 해결을 위해 계획하지 않았던 기술이 필요함을 알게 됩니다.
> 

프로덕트를 목표로 세웠을 때, 이해 없이 구현이 안되었기에, 원리와 구조를 훨씬 많이 배울 수 있었다고 생각합니다.
